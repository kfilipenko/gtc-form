...
| `138_travelgtc_crm_006_conversation_and_contact_actions_task.md` | TRAVELGTC-CRM-006 - Conversation View And Contact Actions | Defines readable Mira dialogue sessions and protected, logged customer-contact actions from CRM. | Implemented |
| `139_travelgtc_crm_006_conversation_and_contact_actions_report.md` | TRAVELGTC-CRM-006 - Conversation And Contact Actions Report | Records the protected readable dialogue and individual contact-action implementation. | Implemented |
...
| `030_travelgtc_auth_001_gtc_identity_registration_gate_spec.md` | TRAVELGTC-AUTH-001 - GTC Identity Registration Gate Specification | Historical specification for shared GTC account reuse. | Superseded by AUTH-003 |
| `031_travelgtc_auth_002_gtc_identity_database_auth_api_mvp_task.md` | TRAVELGTC-AUTH-002 - GTC Identity Database And Auth API MVP | Historical task for first shared identity database/auth API implementation. | Superseded by AUTH-003 |
...
| `068_travelgtc_web_020_route_promo_design_map_image_task.md` | TRAVELGTC-WEB-020 - Route Promo Design And Map Image Task | Defines the handwritten route CTA title, icon-based route formats and map-planning image replacement. | Implemented |
...
| 9.2 | 2026-07-31 | GTC IT / AI Assistant | Kept the pair-model PDF as the sole public format, removed the HTML presentation and switched Mira delivery rules to Azure v28 |
