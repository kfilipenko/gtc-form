...
- Version: 1.4
- Date: 2026-06-03
- Status: Updated after CPG-BIZ-098C SQL draft correction
...
| Contract Agreement Workspace | CC-14 / CF-14 | Populated agreement with embedded condition fields | Group 1, Group 4, Group 5 | CPG-BIZ-091/092/093/094/095/096/097/098A/098B/098C, BP-014 | Workspace model, clause library, catalogs, object/API/UI design, source-first prefill rule, additive SQL draft, source-field reconciliation and exact shortlist candidate link are defined; SQL is not applied | CPG-BIZ-098D corrected SQL draft approval decision for runtime migration packaging. |
| Scripted contract generation | CC-14 / CF-14 | Generated contract instance | System script, responsible employee, control role | CPG-BIZ-093/094/095/096/097/098A/098B/098C, BP-014 | Object/API/UI design, corrected future storage draft and source-field reconciliation are defined; runtime generation not implemented | Future generation implementation after schema approval and migration. |
...
| P1 | Contract workspace corrected SQL draft approval and migration implementation gate | Additive schema draft now includes the required shortlist candidate link; DDL/DML must not run until the corrected draft and runtime migration are separately approved. |
