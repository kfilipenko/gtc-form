...
| Seafarer job-search counter-flow | CC-10 / CF-08A | Seafarer profile + published verified vacancies | Seafarer owner, then review/employer flow | BP-012, BP-013, CPG-BIZ-105 report | Implemented: `/seafarers/job-search/` computes vacancy matches from the saved profile and allows a controlled request for contract consideration through `vacancy_applications` | Future handoff standard for seafarer-initiated request review, employer notification and contract proposal readiness. |
