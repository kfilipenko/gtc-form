...
- Version: 3.8
- Date: 2026-06-10
- Status: Synchronized after CPG-BIZ-126 exclusive delegated management clarification
...
| P1 | Participant representative appointment notifications implementation | Required after CPG-BIZ-126 so seafarers and shipowners can claim agent-created records, appoint/reject/replace representatives and receive safe audit-visible notifications when management responsibility changes. |
...
12. CPG-BIZ-126 - physical-person self-registration, platform-capacity authorization, optional representative appointment, exclusive delegated operational management, agent-created preparation/invitation contexts, one-active-manager rule and assignment notification standard.
