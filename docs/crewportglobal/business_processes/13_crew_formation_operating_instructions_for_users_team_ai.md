...
| Shipowner proceeds with candidate but salary, joining, travel, return, duration or document-readiness terms differ | Review proposed terms | seafarer terms clarification task | Seafarer accepts, rejects or proposes approved alternatives for exact material terms. The result is an auditable terms record, not a free chat message. |
...
| Candidate terms differ from vacancy or seafarer expectations | Clarify candidate terms | terms clarification workspace | Shipowner accepts the seafarer value, keeps the vacancy value, proposes an approved alternative or requests team review. Contract proposal remains blocked until material terms are agreed or closed. |
...
| Review structured terms clarification | responsible team / `review_team` / Group 5 where required | future terms clarification permission | Open the concrete terms clarification workspace. Review only exact material term rows such as salary, joining date, duration, travel, repatriation and document readiness. Do not treat chat text, email text or free notes as the source of agreement. Final contract proposal may proceed only from an agreed terms sheet and existing contract guards. |
...
| Structured terms clarification | seafarer owner, shipowner owner, responsible team, review/control where needed | future terms clarification permission and owner-scoped access | Material differences between vacancy/shipowner terms and seafarer profile/preferences must be resolved as structured term rows with statuses, proposals, accept/reject actions and audit evidence. Free chat must not be the primary agreement source. |
