...
| ICS-002 | Standard protected upload, including human-readable document checklist adapters for finite document catalogs | `projects/crewportglobal/public/assets/crewportglobal-protected-upload.js` plus page checklist adapter | `/create-profile/`, `/post-vacancy/` | Active |
