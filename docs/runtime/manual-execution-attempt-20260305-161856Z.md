# Manual Production Execution Attempt — 20260305-161856Z
...
| nginx_test | BLOCKED | nginx: [alert] could not open error log file: open() "/var/log/nginx/error.log" failed (13: Permission denied) 2026/03/05 16:18:56 [warn] 1967973#1967973: the "user" directive makes sense only if the master process runs with super-user privileges, ignored in /etc/nginx/nginx.conf:1 2026/03/05 16:18:56 [emerg] 1967973#1967973: "location" directive is not allowed here in /var/www/gtc-form/projects/shared/nginx/rjaka-compat.conf:4 nginx: configuration file /etc/nginx/nginx.conf test failed |
