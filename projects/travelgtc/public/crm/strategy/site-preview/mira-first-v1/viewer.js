(() => {
  'use strict';
  const FILE = 'test-travelgtc-mira-first-pages-20260924-v1--mira-first-prototype.json';
  const EXPECTED_SHA = '4434adab8d26d9c541f61790e4f6a9cb9abe73eb16aea7301cbb72f2e30860ca';
  ...
  (async () => {
    try {
      ...
      if (data.schema_version !== 1 || data.project_id !== '0040' || data.id !== 'mira-first-20260924-v1' || data.no_live_ai !== true || data.status !== 'DESIGN_PREVIEW_ONLY' || !['home', 'mira'].every(p => typeof data.pages?.[p] === 'string')) throw Error('scope');
