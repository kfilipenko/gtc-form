(() => {
  'use strict';
  const FILE = 'test-travelgtc-mira-first-pages-20260924-v3--mira-first-prototype.json';
  const EXPECTED_SHA = '3b04227de108b93992edd65828481c3e3b9bad6f4979041a27aa0759be283537';
  ...
  (async () => {
    try {
      ...
      if (data.schema_version !== 1 || data.project_id !== '0040' || data.id !== 'mira-first-20260924-v3' || data.no_live_ai !== true || data.status !== 'DESIGN_PREVIEW_ONLY' || !['home', 'mira'].every(p => typeof data.pages?.[p] === 'string')) throw Error('scope');
