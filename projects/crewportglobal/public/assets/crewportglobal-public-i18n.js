(function () {
  ...
  const CHROME_TRANSLATIONS = {
    en: {
      ...
      'nav.appointAgent': 'Appoint Agent',
      'nav.appointAgentHint': 'Select a registered agent or invite your agent to register, then send the framework agreement offer.',
      ...
      'nav.agentContractsHint': 'Open the agent contract workflow with scoped direct contract drafting tasks.',
      'nav.agentContractPrepare': 'Prepare Contract',
      'nav.agentContractPrepareHint': 'Open computed tasks that create or reuse eligible direct Contract Workspaces.',
      'nav.agentContractTerms': 'Agree Terms',
      'nav.agentContractTermsHint': 'Work with controlled salary, duration, joining, travel and repatriation terms.',
      'nav.agentContractEdit': 'Edit Draft',
      'nav.agentContractEditHint': 'Open the guarded Contract Workspace and edit permitted embedded fields only.',
      'nav.agentContractReview': 'Send for Approval',
      'nav.agentContractReviewHint': 'Send the populated draft to the seafarer and shipowner for direct party review.',
    ...
    ru: {
      ...
      'nav.employerPages': 'Судовладельцам',
    ...
    pt: {
      ...
      'nav.appointAgent': 'Nomear agente',
      'nav.appointAgentHint': 'Selecionar um agente registrado ou convidar seu agente para registrar-se e enviar a oferta do acordo-quadro.',
      ...
      'nav.agentContractsHint': 'Abrir o fluxo de contratos do agente com tarefas de preparacao de contrato direto.',
      'nav.agentContractPrepare': 'Preparar contrato',
      'nav.agentContractPrepareHint': 'Abrir tarefas calculadas que criam ou reutilizam Contract Workspaces elegiveis.',
      'nav.agentContractTerms': 'Acordar termos',
      'nav.agentContractTermsHint': 'Trabalhar com salario, duracao, embarque, viagem e repatriacao controlados.',
      'nav.agentContractEdit': 'Editar minuta',
      'nav.agentContractEditHint': 'Abrir o Contract Workspace protegido e editar apenas campos incorporados permitidos.',
      'nav.agentContractReview': 'Enviar para aprovacao',
      'nav.agentContractReviewHint': 'Enviar a minuta preenchida ao maritimo e ao armador para revisao direta das partes.',
