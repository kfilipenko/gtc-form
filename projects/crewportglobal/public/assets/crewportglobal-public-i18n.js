(function () {
  ...
  const CHROME_TRANSLATIONS = {
    en: {
      ...
      'nav.seafarerPages': 'For Seafarers',
      'nav.seafarerPagesMenu': 'Seafarer pages',
      'nav.employerPages': 'For Employers',
    ...
    ru: {
      ...
      'nav.seafarerPages': 'Для моряков',
      'nav.seafarerPagesMenu': 'Страницы для моряков',
      'nav.employerPages': 'Для работодателей',
    ...
    pt: {
      ...
      'nav.seafarerPages': 'Para marítimos',
      'nav.seafarerPagesMenu': 'Paginas para marítimos',
      'nav.employerPages': 'Para empregadores',
