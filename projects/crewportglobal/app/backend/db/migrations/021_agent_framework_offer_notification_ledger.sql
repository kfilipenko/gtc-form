...
CREATE TABLE IF NOT EXISTS crewportglobal.agent_framework_agreement_offers (
  ...
  framework_template_code TEXT NOT NULL DEFAULT 'CPG-BIZ-123',
  framework_template_version TEXT NOT NULL DEFAULT '1.3',
  signature_method TEXT NOT NULL DEFAULT 'checkbox_acceptance',
  acceptance_text TEXT NOT NULL DEFAULT 'С условиями рамочного договора присоединения согласен',
