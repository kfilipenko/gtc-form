-- CPG-BIZ-098D
-- Contract Agreement Workspace runtime schema.
--
-- Approved for runtime migration after CPG-BIZ-098A/B/C source-first review,
-- source-field reconciliation and shortlist-candidate link correction.
--
