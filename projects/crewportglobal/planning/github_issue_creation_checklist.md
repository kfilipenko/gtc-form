# CrewPortGlobal — GitHub Issue Creation Checklist

- Scope: pre-creation checklist for Increment 1 GitHub implementation issue drafts
- Status: planning-only checklist

## 1. Checklist Purpose

Use this checklist before creating actual GitHub issue drafts from the repository planning files.
...
- [ ] No candidate submission scope has been introduced.
...
This checklist supports GitHub issue draft preparation only.
